...
export default function Header() {
    ...
    return (
        <header className="p-2 sticky top-0 z-50 w-full bg-[#ffa200] backdrop-blur rounded-b-3xl supports-[backdrop-filter]:bg-[#ffa200]/100 flex justify-center text-center items-center text-white">
